...
<body>
	...
	<div class="main">
		...
		<div class="content dos">
			...
			<!--/fotos-->
			<div class="bio">
				Raúl García es el nuevo percusionista de La Otra Eskina, nacido en Sincelejo llega a Pereira a formar parte de la mejor banda muscial que tiene el eje cafetero, y no solo el eje, Colombia Entera y el mundo.
			</div><!--/bio -->
				...
				<div class="comentarios">
					<fb:comments href="<?=$url?>raul.php" num_posts="6" width="500"></fb:comments>
				</div>
			</div><!--/grande-->
